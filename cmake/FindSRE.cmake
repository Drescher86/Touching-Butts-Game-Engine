...
IF(SRE_RELEASE_LIBRARY)
    IF(SRE_DEBUG_LIBRARY)
        SET(SRE_LIBRARY optimized "${SRE_RELEASE_LIBRARY}" debug "${SRE_DEBUG_LIBRARY}")
    ELSE()
        SET(SRE_LIBRARY "${SRE_RELEASE_LIBRARY}")        # Could add "general" keyword, but it is optional
    ENDIF()
ENDIF()
